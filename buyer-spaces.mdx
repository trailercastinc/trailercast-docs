...
A Buyer Space has nine sections. You can hide any section per-Space if it's not relevant for that deal (a small startup deal might skip ROI; a security-conscious enterprise deal might lead with Documents).
