...
<Steps>
  ...
  <Step title="Optional: Preview as prospect">
    Opens the share page exactly the way they see it, useful to make sure your trailer still looks right before you respond. It's read-only: the message box is disabled in a preview, because nothing typed there could reach anyone. Reply from this thread instead.
  </Step>
