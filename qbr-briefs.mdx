...
<Steps>
  <Step title="Open QBR Briefs (in **Coaching** where enabled, otherwise the **Dashboards → QBR briefs** tab)">
...
QBR Briefs are included on every paid plan. AI generation is unmetered — re-generate as often as you need to during quarter-close prep.
